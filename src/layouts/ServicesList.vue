  ...
  <div class="flex flex-wrap w-full text-left">
    <ServiceItem title="AI & Deep Learning" class="basis-1/3">
      ...
      <template v-slot:description>
        From data inception to actionable insights, I desifgdhgfhgfdhfghgn compelling analytics and
        visualization solutions that illuminate trends, empower decision-making, and drive your
        business forward.
      </template>
    </ServiceItem>
    ...
    <ServiceItem title="Python Programming" class="basis-1/3">
      ...
      <template v-slot:description>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor rerum quam quae praesentium
        architecto consequatur ipsam illum adipisci voluptate, excepturi quaerat pariatur optio.
        Animi, at magnam? Vitae eaque odio officiis!
      </template>
    </ServiceItem>
    ...
    <ServiceItem title="Teaching" class="basis-2/3">
      ...
      <template v-slot:description>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor rerum quam quae praesentium
        architecto consequatur ipsam illum adipisci voluptate, excepturi quaerat pariatur optio.
        Animi, at magnam? Vitae eaque odio officiis! Lorem ipsum dolor sit amet consectetur.
        voluptatem.
      </template>
    </ServiceItem>
